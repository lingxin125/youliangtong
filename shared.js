...
(function () {
  ...
  var MOCK_USERS = {
    ...
    "13800008888": { userId: "U002", name: "张老板", roles: ["buyer"], defaultRole: "buyer", merchantId: "YLT202603002", teams: [{ teamId: "T001", teamName: "张老板收购站", role: "owner" }], currentTeamId: "T001" },
  ...
  function activateFarmerRole() {
    var u = getCurrentUser();
    if (!u) return null;
    var roles = Array.isArray(u.roles) ? u.roles.slice() : [];
    if (roles.indexOf("farmer") < 0) roles.push("farmer");
    u.roles = roles;
    u.defaultRole = u.defaultRole || "buyer";
    u.currentRole = "farmer";
    u.currentTeamId = null;
    u.currentTeamName = "";
    u.currentTeamRole = null;
    try {
      _storage().removeItem("ylt_user_current_team_v1");
    } catch (e) {}
    _storage().setItem(CURRENT_KEY, JSON.stringify(u));
  ...
  window.UserIdentityStore = {
    ...
    activateFarmerRole: activateFarmerRole,
    getRoleLabel: getRoleLabel,
